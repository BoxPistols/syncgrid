...
const PATHS: Record<IconName, string> = {
  ...
  github:
    'M12 2C6.48 2 2 6.58 2 12.25c0 4.53 2.87 8.37 6.84 9.72.5.1.68-.22.68-.49v-1.7c-2.78.62-3.37-1.37-3.37-1.37-.45-1.18-1.11-1.5-1.11-1.5-.9-.64.07-.62.07-.62 1 .07 1.53 1.06 1.53 1.06.89 1.57 2.34 1.11 2.91.85.09-.66.35-1.11.63-1.37-2.22-.26-4.56-1.14-4.56-5.07 0-1.12.39-2.03 1.03-2.75-.1-.26-.45-1.3.1-2.7 0 0 .84-.28 2.75 1.05a9.3 9.3 0 015 0c1.91-1.33 2.75-1.05 2.75-1.05.55 1.4.2 2.44.1 2.7.64.72 1.03 1.63 1.03 2.75 0 3.94-2.34 4.8-4.57 5.06.36.32.68.94.68 1.9v2.81c0 .27.18.6.69.49A10.14 10.14 0 0022 12.25C22 6.58 17.52 2 12 2z',
  'git-commit': 'M12 15a3 3 0 100-6 3 3 0 000 6zM3 12h6M15 12h6',
  'git-pr': 'M6 9a3 3 0 100-6 3 3 0 000 6zM6 9v12M18 15a3 3 0 103 3M18 15V9a3 3 0 00-3-3h-3M13.5 3.5L12 6l2.5 1.5',
