export const ja = {
  ...
  helpQsTabs: 'タブの使い方',
  helpQsTabsDesc: 'ALLタブで全ブックマークを一覧。各グループタブで絞り込み。＋ボタンで新しいグループを追加',
  helpQsAdd: 'ブックマークの追加',
  helpQsAddDesc: 'Ctrl+N でブックマーク追加フォームを開きます。URLを入力するとタイトルが自動取得されます',
  helpQsFolders: 'フォルダの操作',
  helpQsFoldersDesc: 'フォルダをクリックして展開・折りたたみ。右クリックメニューから名前変更・削除が可能',
  helpQsDrag: 'ドラッグ＆ドロップ',
  helpQsDragDesc: 'ブックマークやフォルダをドラッグして並べ替え・移動。別のフォルダへのドロップも可能',
  // Help — 機能リファレンス
  ...
  helpRefShortcutsDesc: '? キーでショートカット一覧を表示。設定画面からキーバインドをカスタマイズ可能',
  helpRefAi: 'AI機能',
  helpRefAiDesc: '設定画面でAPIキーを設定すると、タイトル自動整理・自動タグ付けが利用可能',
  helpRefExport: 'エクスポート / インポート',
  ...
  kanbanSyncError: '他の端末との同期に失敗しました（この端末には保存済みです）',
